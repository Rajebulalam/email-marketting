        ...
        <section className='w-full lg:w-11/12 px-4 lg:px-6 mx-auto pt-3 py-12'>
            ...
            >
                ...
                <SwiperSlide className='slide slide-second'>
                    <div className='slide-content grid grid-cols-1 md:grid-cols-2 gap-7 items-center bg-accent px-16 mx-16 py-10'>
                        <div>
                            <h2 className='text-4xl font-semibold lg:pr-[150px]'>“Customers and interested parties engaged.”</h2>
                        </div>
                        <div>
                            <div>
                ...
                <SwiperSlide className='slide slide-second'>
                    <div className='slide-content grid grid-cols-1 md:grid-cols-2 gap-7 items-center bg-accent px-16 mx-16 py-10'>
                        <div>
                            <h2 className='text-4xl font-semibold pr-0 lg:pr-[150px]'>“Customers and interested parties engaged.”</h2>
                        </div>
                        <div>
                            <div>
                                <p>“I found it easy to capture my ideas and sketch visuals to sheare with my clints on the go”</p>
