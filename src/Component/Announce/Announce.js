...
const Announce = () => {
    return (
        <section className='w-full lg:w-11/12 px-4 lg:px-6 mx-auto pt-3 py-12'>
            <h2 className='text-center font-bold text-3xl pt-10 pb-2 lg:pb-10'>All you need to A <br /> single platform</h2>
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 pt-14'>
                <div>
                    <h3 className='text-2xl font-bold pb-4 pr-0 lg:pr-10'>Homework to help you take action.</h3>
