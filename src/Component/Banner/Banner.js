...
const Banner = () => {
    return (
        <div>
            <div className='bg-accent py-10 pb-[280px] sm:pb-[330px]'>
                <div className='w-full lg:w-6/12 px-4 lg:px-6 mx-auto'>
                    ...
                    <div className='text-center py-6'>
                        <input className='px-4 w-[230px] lg:w-[300px] py-2 mr-2 shadow-xl' type="search" name="search" id="search" />
                        <button className='text-white px-3 p-2 bg-black'>Let's Talk</button>
                    </div>
                </div>
            </div>
            <div className='pl-5 mt-[-230px] sm:mt-[-310px] flex justify-center'>
